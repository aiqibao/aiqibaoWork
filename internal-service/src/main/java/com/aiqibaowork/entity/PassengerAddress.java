...
public class PassengerAddress {
     ...
     * @mbg.generated
     */
    public PassengerAddress(Integer id, Integer passengerInfoId, Double latitude, Double longitude, String addressName, Integer type, String addressDesc, Date createTime, Date updateTime) {
        this.id = id;
